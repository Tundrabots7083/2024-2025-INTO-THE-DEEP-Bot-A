...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 0.0; // yDirection position of the first parallel encoder (in tick units)
        public double par1YTicks = 1.0; // yDirection position of the second parallel encoder (in tick units)
